...
export const Route = createFileRoute('/guides/translation-support-workflow')({
  ...
  head: () =>
    buildPublicPageHead(
      ...
      'A permission-safe manga AI translation workflow for TachiyomiAT hosted OCR, glossary control, human review, contributor credit, manhwa translate ai support, and takedown-ready handling.',
