...
function buildArticlePrompt(input: {
  ...
  return [
    ...
    '',
    'Rules:',
    '- Target searches around manga translate ai, manhwa translate ai, manhua translate ai, AI translation, OCR translation, translation app, Nayovi, TachiyomiAT, Tachiyomi, Mihon, and Tachiyomi download intent.',
    ...
    '- When relevant, include one natural sentence for readers coming from TachiyomiAT, Tachiyomi, or Mihon-style Android workflows.',
