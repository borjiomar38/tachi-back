...
describe('device router', () => {
  ...
  describe('getById', () => {
    it('returns the device detail with active and historical license bindings', async () => {
        ...
        extensionVisits: [
          {
            ...
            firstVisitedAt: new Date('2026-03-19T18:00:00.000Z'),
            iconUrl: 'https://example.com/webtoon.png',
            id: 'extension-visit-1',
            lastVisitedAt: now,
        ...
        mangaVisits: [
          {
            ...
            firstVisitedAt: new Date('2026-03-19T18:15:00.000Z'),
            id: 'manga-visit-1',
            lastVisitedAt: now,
            mangaUrl: 'https://example.com/manga/omniscient-reader',
            sourceId: '123',
            sourceLanguage: 'en',
            sourceName: 'Webtoon',
            thumbnailUrl: 'https://example.com/omniscient-reader.jpg',
      ...
      mockDb.extensionBlock.findMany.mockResolvedValue([
        {
          packageName: 'eu.kanade.tachiyomi.extension.en.webtoon',
        },
      ]);
