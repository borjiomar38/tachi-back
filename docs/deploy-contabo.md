...
SEO_AGENT_INITIAL_SLEEP_SECONDS=0
...
logos, device mockups, software interfaces, captured screens, readable text,
sexualized minors, and unsupported claims.
